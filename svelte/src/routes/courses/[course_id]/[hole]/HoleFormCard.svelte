        ...
        <h5 class="card-title">
            ...
            <div class="next-and-prev">
                <div class="btn-group mr-2" role="group" aria-label="First group">
                    {#if holeNumber !== 1}
                        <a href="/courses/{courseId}/{holeNumber - 1}" rel="external" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i></a>
                    {/if}
                    {#if holeNumber !== 18}
                        <a href="/courses/{courseId}/{holeNumber + 1}" rel="external" class="btn btn-secondary"><i class="fa-solid fa-arrow-right"></i></a>
                    {:else}
