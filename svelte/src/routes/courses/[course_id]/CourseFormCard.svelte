...
<div class="card">
    <div class="card-body">
        ...
        <div class="row align-items-start">
            ...
            <div class="col-6">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="number-of-holes-addon"><i class="fa-solid fa-flag"></i></span>
                    <input type="text" class="form-control" placeholder="Number of Holes" aria-describedby="number-of-holes-addon" bind:value={course.numberOfHoles}>
                </div>
            </div>
        </div>
        <div class="input-group mb-3 col-6">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" id="designer-addon"><i class="fa-solid fa-signature"></i></span>
            <input type="text" class="form-control" placeholder="Designer" aria-describedby="designer-addon" bind:value={course.designer}>
        </div>
        <div class="input-group mb-3">
